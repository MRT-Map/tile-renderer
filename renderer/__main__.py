...
if args.task == "info":
    ...
    print(term.yellow("Made by __7d for the OpenMRTMap project"))
...
if args.task == "nodebuilder":
    import renderer.nodeJsonBuilder
elif args.task == "render" and __name__ == '__main__':
    renderer.render(renderer.internal.readJson(args.plaJson), renderer.internal.readJson(args.nodeJson), renderer.misc.getSkin(args.skinJson), args.minZoom, args.maxZoom, args.maxZoomRange, saveDir=args.saveDir, processes=args.processes, tiles=args.tiles)